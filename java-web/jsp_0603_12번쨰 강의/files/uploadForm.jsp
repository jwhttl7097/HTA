			...
			<!-- 
				enctype
					...
					- enctype="multipart/form=data"
						- 첨부파일이 포함된 폼 입력값을 제출할 떄 사용되는 인코딩 방식이다.
						- 요청메세지의 요청 파라미터값을 request.getParameter(String name)로 조회할 수 없다.
						- 요청메세지의 요청파라미터값, 업로드 되는 첨부파일 처리를 위한 추가 라이브러리가 필요함
						...
						- [변환예시]
		                     ...
		                     ----WebKitFormBoundaryQtk5bV9PVWAMOkEI
			 -->
			<form class="p-3 border bg-light" action="/upload" method="post" enctype="multipart/form-data">
