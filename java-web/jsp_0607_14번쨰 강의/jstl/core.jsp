...
<div class="container">
   <div class="row">
      <div class="col-12 mb-3">
         <h3>out 태그</h3>
         <div><strong>el 태그 : </strong>${text1}</div>
         <div><strong>out 태그 : </strong><c:out value="${text1 }"/></div>
         <div><strong>el 태그 : </strong>${text2}</div>
         <div><strong>out 태그 : </strong><c:out value="${text2 }"/></div>
         
         <h3>out 태그</h3>
         <div><strong>el 태그 : </strong>${text2}</div>
         <div><strong>out 태그 : </strong><c:out value="${text2 }"/></div>
         <div><strong>out 태그 : </strong><c:out value="${text2 }" escapeXml="false"/></div>
      </div>
   </div>
   <div class="row mb-3">
   	<div class="col-12">
   		<h3>if 태그</h3>
   			...
   			<c:if test="${car.year >= 5 || car.distance >= 100000}">
   				<p>유상처리 대상 차량입니다.</p>
   			</c:if>
  	...
  	<div class="row mb-3">
  		<div class="col-6">
  			...
  			<p>링크 : <a href="${bookDetatilLink }">상세보기</a></p>
  		</div>
  	</div>
</div>
</body>
