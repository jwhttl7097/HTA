...
<script type="text/javascript">
	...
	console.log("정수/정수", num1/num2);
	console.log("소숫점 없애기", Math.trunc(result));
	console.log("반올림 하기", Math.round(result));
	...
	console.log("5 != '5'", 5 != '5');		// false	타입이 다르지만 변환후 값이 같아서 false
	console.log("5 != 8", 5 != 8);			// true		값이 달라서 true
	console.log("5 != '8'", 5 != '8');		// true		타입도 다르고, 값도 달라서 true
