...
<script type="text/javascript">
	...
	var numbers2 = [];
	// 배열객체의 push()메소드를 이용하면 배열의 맨마지막요소 다음에 새로운 요소를 추가한다.
	numbers2.push(100);
	numbers2.push(200);
	numbers2.push(300);
	numbers2.push(400);
	...
	var numbers3 = [];
	// 배열객체의 push()메소드를 이용하면 배열의 맨처음 요소 앞에 새로운 요소를 추가한다.
...
// 	console.log(numbers4.pop(), numbers4);
	...
	// 배열.splice(1, 0, 값, 값, 값) : 배열의 1번째부터 값을 삭제하지 않고 그 자리에 값들을 추가한다 (기존 인덱스에 있는 값은 뒤로 밀림).
