...
<body>
	<h1>이벤트 연습</h1>
	<div id="text-box">
		<div id="text-box-1">첫번쨰 글 박스입니다.</div>
		<div id="text-box-2">두번쨰 글 박스입니다.</div>
		<div id="text-box-3">세번쨰 글 박스입니다.</div>
	</div>	
		<input type="text" id="test" onmouseout="forthEventHandler()">
		
	<div id="btn-box">
		<!-- 
			사용자가 버튼을 클릭했을 때 사용자와 상호작용하기 위해서 onclick 이벤트를 사용함.
			해당 엘리먼트에 onclick 이벤트가 발생하면 실행될 이벤트핸들러 함수를 바인딩시킨다.
		 -->
		...
		<button onclick="forthEventHandler()">버튼4</button>
	</div>
