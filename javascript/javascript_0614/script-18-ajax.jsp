...
<script type="text/javascript">
	...
	function getEmployees(deptId) {
		...
		// XMLHttpRequest 객체 생성 (ajax요청을 위해)
		var xhr = new XMLHttpRequest();
		
// 		console.log("xhr의 진행상태", xhr.readyState); // readyState는 진행상황을 알려주고 4일때 준비완료된 상태이다.

		// XMLHttpRequest 객체에서 onreadystatechange 이벤트 발생시 실행할 콜백함수 등록
		xhr.onreadystatechange = function() {
			...
			if(xhr.readyState == 4 && xhr.status == 200) {
				...
				// json표기법으로 작성된 텍스트를 자바스크립트의 배열로 변환 하기
				...
				// <tbody> 엘리먼트에 생성된 <tr>, <td>태그로 구성된 HTML 컨텐츠를 
