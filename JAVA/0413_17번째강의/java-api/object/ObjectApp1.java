...
public class ObjectApp1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("p1이 참조하는 객체와 p2가 참조하는 객체가 같은객체인가? " + result1);
		System.out.println("p2이 참조하는 객체와 p1가 참조하는 객체가 같은객체인가? " + result2);
		
		boolean result3 = p1.equals(p3);
		boolean result4 = p2.equals(p4);
		System.out.println("p1이 참조하는 객체와 p3가 참조하는 객체가 같은객체인가? " + result3);
		System.out.println("p2이 참조하는 객체와 p4가 참조하는 객체가 같은객체인가? " + result4);
	}
}
