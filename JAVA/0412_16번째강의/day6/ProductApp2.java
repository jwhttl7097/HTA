...
public class ProductApp2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("### 사이즈가 S고 가격이 5만원 이상 10만원 미만인 상품만 출력");
		printProducts(products, new Predicate() {
			@Override
			public boolean test(Product item) {
		...
		printProducts(products, item -> item.getSize().equals("XL")); // -> item.getSize().equals("XL")이부분이 Predicate의 test메소드 result값
