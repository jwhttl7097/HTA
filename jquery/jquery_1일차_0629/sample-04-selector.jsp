...
<div class="container">
	...
	<div id="box-1">
		...
		<h4>리스트</h4>
		<ul>
			<li><a href="">리스트링크1</a></li>
			<li><a href="">리스트링크2</a></li>
			<li><a href="">리스트링크3</a></li>
			<li><a href="">리스트링크4</a></li>
		</ul>
	</div>
...
<script type="text/javascript">
	...
	// 첫번째 div의 맨마지막번째 리스트링크4와 두번쨰 div의 맨마지막번쨰 리스트링크4를 선택해서 배경색을 회색으로
	...
	// 세번쨰 div의 h3 다음에 있는 모든 링크를 선택해서 글자를 이탤릭체로 표시하기
